SCENARIOS = {
    ...
    'Sales Executive': 'A major client is upset because a promised feature was delay by 2 months. They are threatening to switch to a competitor. How would you address this?',
